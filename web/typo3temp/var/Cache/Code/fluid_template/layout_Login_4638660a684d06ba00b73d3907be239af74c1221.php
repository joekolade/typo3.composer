...
class layout_Login_4638660a684d06ba00b73d3907be239af74c1221 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['logo']) ? $renderingContext->getVariableProvider()['logo'] : NULL, ENT_QUOTES);
...
$output126 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments127, $renderChildrenClosure128, $renderingContext), ENT_QUOTES);
...
$output126 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments129, $renderChildrenClosure130, $renderingContext), ENT_QUOTES);
...
// Rendering Array
$array123 = array();
$array123['0'] = isset($renderingContext->getVariableProvider()['hasLoginError']) ? $renderingContext->getVariableProvider()['hasLoginError'] : NULL;
...
$output120 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['loginProviderIdentifier']) ? $renderingContext->getVariableProvider()['loginProviderIdentifier'] : NULL, ENT_QUOTES);
...
$output120 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments155, $renderChildrenClosure156, $renderingContext), ENT_QUOTES);
...
$output120 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments157, $renderChildrenClosure158, $renderingContext), ENT_QUOTES);
...
$output175 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('providerKey', $array176), ENT_QUOTES);

$output175 .= '"><a href="?loginProvider=';
$array177 = array (
);
$output175 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('providerKey', $array177), ENT_QUOTES);

$output175 .= '"><i class="fa fa-fw ';
$array178 = array (
);
$output175 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('provider.icon-class', $array178), ENT_QUOTES);
...
$output175 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments179, $renderChildrenClosure180, $renderingContext), ENT_QUOTES);
...
// Rendering Array
$array171 = array();
$array171['0'] = isset($renderingContext->getVariableProvider()['loginProviderIdentifier']) ? $renderingContext->getVariableProvider()['loginProviderIdentifier'] : NULL;
$array171['1'] = ' != ';
$array173 = array (
);$array171['2'] = $renderingContext->getVariableProvider()->getByPath('providerKey', $array173);

$expression174 = function($context) {return (($context["node0"]) != ($context["node2"]));};
...
$expression167 = function($context) {return ($context["node0"]);};
...
$arguments159['each'] = isset($renderingContext->getVariableProvider()['loginProviders']) ? $renderingContext->getVariableProvider()['loginProviders'] : NULL;
...
$output184 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments185, $renderChildrenClosure186, $renderingContext), ENT_QUOTES);
...
$output184 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('backendUser.username', $array187), ENT_QUOTES);
...
$output212 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments213, $renderChildrenClosure214, $renderingContext), ENT_QUOTES);
...
$arguments227['value'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array223 = array();
$array223['0'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;

$expression225 = function($context) {return ($context["node0"]);};
...
// Rendering Array
$array206 = array();
$array206['0'] = isset($renderingContext->getVariableProvider()['showInterfaceSelector']) ? $renderingContext->getVariableProvider()['showInterfaceSelector'] : NULL;

$expression208 = function($context) {return ($context["node0"]);};
...
$arguments203['value'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array199 = array();
$array199['0'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
$output184 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments230, $renderChildrenClosure231, $renderingContext), ENT_QUOTES);
...
// Rendering Array
$array114 = array();
$array114['0'] = isset($renderingContext->getVariableProvider()['formType']) ? $renderingContext->getVariableProvider()['formType'] : NULL;
$array114['1'] = ' == \'LoginForm\'';

$expression116 = function($context) {return (($context["node0"]) == 'LoginForm');};
...
$output10 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments13, $renderChildrenClosure14, $renderingContext), ENT_QUOTES);
...
// Rendering Array
$array7 = array();
$array7['0'] = isset($renderingContext->getVariableProvider()['hasLoginError']) ? $renderingContext->getVariableProvider()['hasLoginError'] : NULL;
...
$output4 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['loginProviderIdentifier']) ? $renderingContext->getVariableProvider()['loginProviderIdentifier'] : NULL, ENT_QUOTES);
...
$output4 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments39, $renderChildrenClosure40, $renderingContext), ENT_QUOTES);
...
$output4 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments41, $renderChildrenClosure42, $renderingContext), ENT_QUOTES);
...
$output59 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('providerKey', $array60), ENT_QUOTES);

$output59 .= '"><a href="?loginProvider=';
$array61 = array (
);
$output59 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('providerKey', $array61), ENT_QUOTES);

$output59 .= '"><i class="fa fa-fw ';
$array62 = array (
);
$output59 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('provider.icon-class', $array62), ENT_QUOTES);
...
$output59 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments63, $renderChildrenClosure64, $renderingContext), ENT_QUOTES);
...
// Rendering Array
$array55 = array();
$array55['0'] = isset($renderingContext->getVariableProvider()['loginProviderIdentifier']) ? $renderingContext->getVariableProvider()['loginProviderIdentifier'] : NULL;
$array55['1'] = ' != ';
$array57 = array (
);$array55['2'] = $renderingContext->getVariableProvider()->getByPath('providerKey', $array57);

$expression58 = function($context) {return (($context["node0"]) != ($context["node2"]));};
...
$arguments43['each'] = isset($renderingContext->getVariableProvider()['loginProviders']) ? $renderingContext->getVariableProvider()['loginProviders'] : NULL;
...
$output66 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments67, $renderChildrenClosure68, $renderingContext), ENT_QUOTES);
...
$output66 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('backendUser.username', $array69), ENT_QUOTES);
...
$output94 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments95, $renderChildrenClosure96, $renderingContext), ENT_QUOTES);
...
$arguments109['value'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array105 = array();
$array105['0'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;

$expression107 = function($context) {return ($context["node0"]);};
...
// Rendering Array
$array88 = array();
$array88['0'] = isset($renderingContext->getVariableProvider()['showInterfaceSelector']) ? $renderingContext->getVariableProvider()['showInterfaceSelector'] : NULL;
...
$output72 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments73, $renderChildrenClosure74, $renderingContext), ENT_QUOTES);
...
$arguments85['value'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array81 = array();
$array81['0'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
$output66 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments112, $renderChildrenClosure113, $renderingContext), ENT_QUOTES);
...
$output0 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments235, $renderChildrenClosure236, $renderingContext), ENT_QUOTES);

$output0 .= '</span>
							<img src="';

$output0 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['images']['typo3']) ? $renderingContext->getVariableProvider()['images']['typo3'] : NULL, ENT_QUOTES);
...
$output0 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments238, $renderChildrenClosure239, $renderingContext), ENT_QUOTES);
...
return isset($renderingContext->getVariableProvider()['copyright']) ? $renderingContext->getVariableProvider()['copyright'] : NULL;
};
$arguments240 = array();
$arguments240['value'] = NULL;

$output0 .= $renderChildrenClosure241();
...
$output0 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments243, $renderChildrenClosure244, $renderingContext), ENT_QUOTES);
