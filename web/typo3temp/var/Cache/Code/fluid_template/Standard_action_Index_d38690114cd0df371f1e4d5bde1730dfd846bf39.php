...
class Standard_action_Index_d38690114cd0df371f1e4d5bde1730dfd846bf39 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['images']['capslock']) ? $renderingContext->getVariableProvider()['images']['capslock'] : NULL, ENT_QUOTES);
...
$output22 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['images']['capslock']) ? $renderingContext->getVariableProvider()['images']['capslock'] : NULL, ENT_QUOTES);
