...
class Standard_action_Index_d3bc4f73e85bd7bb239f420d644e473974ffcf61 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['storeLastActiveTab']) ? $renderingContext->getVariableProvider()['storeLastActiveTab'] : NULL, ENT_QUOTES);
...
$array15 = array();
$array16 = array (
);$array15['0'] = htmlspecialchars($renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array16), ENT_QUOTES);
$array15['1'] = ' == ';
$array15['2'] = htmlspecialchars(isset($renderingContext->getVariableProvider()['defaultTabIndex']) ? $renderingContext->getVariableProvider()['defaultTabIndex'] : NULL, ENT_QUOTES);
...
$output12 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['id']) ? $renderingContext->getVariableProvider()['id'] : NULL, ENT_QUOTES);

$output12 .= '-';
$array20 = array (
);
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array20), ENT_QUOTES);

$output12 .= '" title="';
$array21 = array (
);
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('item.linkTitle', $array21), ENT_QUOTES);
...
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array23), ENT_QUOTES);
...
$output12 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('item.label', $array33), ENT_QUOTES);
...
$expression38 = function($context) {return ($context["node0"]);};
...
$output48 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments49, $renderChildrenClosure50, $renderingContext);
...
$arguments3['each'] = isset($renderingContext->getVariableProvider()['items']) ? $renderingContext->getVariableProvider()['items'] : NULL;
$arguments3['as'] = 'item';
...
$array65 = array();
$array66 = array (
);$array65['0'] = htmlspecialchars($renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array66), ENT_QUOTES);
$array65['1'] = ' == ';
$array65['2'] = htmlspecialchars(isset($renderingContext->getVariableProvider()['defaultTabIndex']) ? $renderingContext->getVariableProvider()['defaultTabIndex'] : NULL, ENT_QUOTES);

$expression68 = function($context) {return (($context["node0"]) == ($context["node2"]));};
...
$output62 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['id']) ? $renderingContext->getVariableProvider()['id'] : NULL, ENT_QUOTES);

$output62 .= '-';
$array70 = array (
);
$output62 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array70), ENT_QUOTES);
...
$array79 = array (
);return htmlspecialchars($renderingContext->getVariableProvider()->getByPath('item.description', $array79), ENT_QUOTES);
};
$arguments77 = array();
...
// Rendering Array
$array90 = array();
$array90['0'] = isset($renderingContext->getVariableProvider()['wrapContent']) ? $renderingContext->getVariableProvider()['wrapContent'] : NULL;
...
$arguments53['each'] = isset($renderingContext->getVariableProvider()['items']) ? $renderingContext->getVariableProvider()['items'] : NULL;
$arguments53['as'] = 'item';
