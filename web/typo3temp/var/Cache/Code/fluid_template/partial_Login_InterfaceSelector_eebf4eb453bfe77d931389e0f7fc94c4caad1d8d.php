...
class partial_Login_InterfaceSelector_eebf4eb453bfe77d931389e0f7fc94c4caad1d8d extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output25 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments26, $renderChildrenClosure27, $renderingContext), ENT_QUOTES);
...
$arguments40['value'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array36 = array();
$array36['0'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array19 = array();
$array19['0'] = isset($renderingContext->getVariableProvider()['showInterfaceSelector']) ? $renderingContext->getVariableProvider()['showInterfaceSelector'] : NULL;

$expression21 = function($context) {return ($context["node0"]);};
...
$output3 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments4, $renderChildrenClosure5, $renderingContext), ENT_QUOTES);
...
$arguments16['value'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
...
// Rendering Array
$array12 = array();
$array12['0'] = isset($renderingContext->getVariableProvider()['interface']) ? $renderingContext->getVariableProvider()['interface'] : NULL;
