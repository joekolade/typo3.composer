...
class FileList_action_Index_b93aa1cdf3fb95cf8ec1539dce9c002fb074d989 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['headline']) ? $renderingContext->getVariableProvider()['headline'] : NULL, ENT_QUOTES);
...
$output2 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments3, $renderChildrenClosure4, $renderingContext);
...
return isset($renderingContext->getVariableProvider()['listHtml']) ? $renderingContext->getVariableProvider()['listHtml'] : NULL;
};
$arguments9 = array();
...
return isset($renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['html']) ? $renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['html'] : NULL;
};
$arguments24 = array();
...
$output23 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['label']) ? $renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['label'] : NULL, ENT_QUOTES);
...
// Rendering Array
$array20 = array();
$array20['0'] = isset($renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['enabled']) ? $renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['enabled'] : NULL;
...
return isset($renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['html']) ? $renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['html'] : NULL;
};
$arguments34 = array();
...
$output33 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['label']) ? $renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['label'] : NULL, ENT_QUOTES);
...
// Rendering Array
$array30 = array();
$array30['0'] = isset($renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['enabled']) ? $renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['enabled'] : NULL;
...
return isset($renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['html']) ? $renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['html'] : NULL;
};
$arguments44 = array();
...
$output43 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['label']) ? $renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['label'] : NULL, ENT_QUOTES);
...
// Rendering Array
$array40 = array();
$array40['0'] = isset($renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['enabled']) ? $renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['enabled'] : NULL;
...
return isset($renderingContext->getVariableProvider()['clipBoardHtml']) ? $renderingContext->getVariableProvider()['clipBoardHtml'] : NULL;
};
$arguments54 = array();
...
// Rendering Array
$array50 = array();
$array50['0'] = isset($renderingContext->getVariableProvider()['showClipBoard']) ? $renderingContext->getVariableProvider()['showClipBoard'] : NULL;
...
// Rendering Array
$array14 = array();
$array14['0'] = isset($renderingContext->getVariableProvider()['listHtml']) ? $renderingContext->getVariableProvider()['listHtml'] : NULL;
...
$output59 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\LayoutViewHelper::renderStatic($arguments60, $renderChildrenClosure61, $renderingContext), ENT_QUOTES);
...
$output64 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['headline']) ? $renderingContext->getVariableProvider()['headline'] : NULL, ENT_QUOTES);
...
$output89 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['label']) ? $renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['label'] : NULL, ENT_QUOTES);
...
// Rendering Array
$array86 = array();
$array86['0'] = isset($renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['enabled']) ? $renderingContext->getVariableProvider()['checkboxes']['bigControlPanel']['enabled'] : NULL;
...
$output99 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['label']) ? $renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['label'] : NULL, ENT_QUOTES);
...
// Rendering Array
$array96 = array();
$array96['0'] = isset($renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['enabled']) ? $renderingContext->getVariableProvider()['checkboxes']['displayThumbs']['enabled'] : NULL;
...
$output109 .= htmlspecialchars(isset($renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['label']) ? $renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['label'] : NULL, ENT_QUOTES);
...
// Rendering Array
$array106 = array();
$array106['0'] = isset($renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['enabled']) ? $renderingContext->getVariableProvider()['checkboxes']['enableClipBoard']['enabled'] : NULL;

$expression108 = function($context) {return ($context["node0"]);};
...
// Rendering Array
$array116 = array();
$array116['0'] = isset($renderingContext->getVariableProvider()['showClipBoard']) ? $renderingContext->getVariableProvider()['showClipBoard'] : NULL;
...
// Rendering Array
$array80 = array();
$array80['0'] = isset($renderingContext->getVariableProvider()['listHtml']) ? $renderingContext->getVariableProvider()['listHtml'] : NULL;
