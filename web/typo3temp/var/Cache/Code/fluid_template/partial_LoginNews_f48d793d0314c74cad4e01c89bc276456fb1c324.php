...
class partial_LoginNews_f48d793d0314c74cad4e01c89bc276456fb1c324 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments7['each'] = isset($renderingContext->getVariableProvider()['loginNewsItems']) ? $renderingContext->getVariableProvider()['loginNewsItems'] : NULL;
$arguments7['as'] = 'item';
...
// Rendering Array
$array3 = array();
$array3['0'] = isset($renderingContext->getVariableProvider()['loginNewsItems']) ? $renderingContext->getVariableProvider()['loginNewsItems'] : NULL;
